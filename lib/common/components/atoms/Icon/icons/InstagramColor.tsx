...
const InstagramColor: React.FC<Props> = (props) => (
  <svg
  ...
  >
    <defs>
      <radialGradient
        ...
        cy={578.088}
        r={65}
        xlinkHref="#instagram-color_svg__a"
