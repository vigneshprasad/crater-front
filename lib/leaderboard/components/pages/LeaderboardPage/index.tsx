    ...
    <Box>
      ...
      >
        ...
        >
          ...
          <Text mb={space.xs}>
            Take part in a competition with other streamers &amp; win cash week.
            Start by picking a category of streamers you want to against.
            against. Once you enter the competition, set up your stream invite
            invite your friends to watch. If you get the most time spent on your
            ( Number of Viewers x Watch Time ) you win the competition. Details
            are in the FAQ.
          </Text>
      ...
      <Box px={[space.xs, space.s]} py={space.xs}>
        ...
        >
          ...
          <FaqExpander
            heading="How is the winner determined, weekly?"
            subText="The streamer with the most time viwed wins. Time spent is equal to the number of viewers x watch time. This is done weekly & monthly. The max stream length is 2 hrs a day."
          />

          <FaqExpander
            heading="What do I get if I am the top weekly or monthly streamer?"
            subText="Weekly prizes: leader (1st) gets paid 6k, 2nd 3k & third 1k."
          />
